A simple Python program (`student_info.py`) that collects and/or displays student information.

## Features

- Accepts student details through user input.
- Displays the entered information in a clear format.
- Easy to modify for additional fields or functionality.
